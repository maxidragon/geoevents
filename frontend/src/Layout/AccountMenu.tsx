  ...
  return (
    <>
      <Tooltip title="Account">
        ...
        >
          <Avatar sx={{ bgcolor: deepOrange[500], color: "white" }}>{user.username.slice(0, 1).toUpperCase()}</Avatar>
        </IconButton>
      </Tooltip>
      <Menu
        anchorEl={anchorEl}
      ...
      >
        {isAdmin() && (
          <>
            <MenuItem onClick={handleClose} component={Link} to="/events/new">
              <ListItemIcon>
        ...
        <MenuItem onClick={handleClose} component={Link} to="/events/mine">
          <ListItemIcon>
